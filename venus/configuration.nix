...
{ config, lib, options, modulesPath, pkgs, ... }: with lib; {
  ...
  services.nfs.server = {
    ...
    exports = ''
      ...
      # jupiter.tailcdc44b.ts.net. jupiter.home.daz.cat.
      ...
      /ocean -rw 100.64.202.115 172.19.42.3
      /ocean/active -rw 100.64.202.115 172.19.42.3
      /ocean/private -rw 100.64.202.115 172.19.42.3
      /ocean/public -rw 100.64.202.115 172.19.42.3
    '';
  };
