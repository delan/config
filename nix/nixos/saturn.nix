...
#       z_pkg = { fetchurl, buildLinux, ... } @ args:
#         buildLinux (args // rec {
#           version = "5.9.16";
#           modDirVersion = version;
#           # extraMeta.branch = "5.9";
#           src = fetchurl {
#             url = "https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.9.16.tar.xz";
#             sha256 = "11mbnjvb5d5gwbrwlkqvzpg1ij4m19l5wr3wca9iiyg5i2papmxh";
#           };
#           kernelPatches = [];
#         } // (args.argsOverride or {}));
#       z = pkgs.callPackage z_pkg {};
#     in
#       pkgs.recurseIntoAttrs (pkgs.linuxPackagesFor z);
...
### "isolcpus=1-5,7-11" "rcu_nocbs=1-5,7-11" ### "nohz_full=1-5,7-11"
    ...
    networking.firewall.allowedUDPPorts = [ 13368 13369 137 138 ];
